...
export default function UserCreationForm({ onBack, onSubmit, onCancel }) {
  ...
  return (
    <div className="flex min-h-5xl items-center justify-center bg-slate-50 p-4">
      <div className="max-w-5xl w-full rounded-xl border border-slate-200 bg-white p-6 overflow-hidden">
        {/* Header */}
        <div className="mb-6 flex items-center gap-3">
          <Link to="/settings/user-management/list">
        ...
        <div className="mb-5 grid grid-cols-1 gap-5 md:grid-cols-2">
          ...
          <div>
            ...
            <input
              type="email"
              defaultValue="Bhaneshvar@cylsys.com"
